"""
	...
	4) 	Next, you need to look through the JPG files, decide which you would like to keep, and move the JPGs you would like to keep into the Highlights folder.
	 	After you have selected the highlights of each date that you enjoy and moved those JPGs in to the highlights folder within that date, you can go to the next step
